      ...
      <main className="min-h-screen pt-16 grid-bg">
        ...
        <section className="relative max-w-3xl mx-auto px-6 py-20 md:py-28">
          <div className="mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-5" style={{ color: '#DCE3EF' }}>
              Get AI Ops Insights From Groundwork AI
            </h1>
            <p className="text-lg leading-relaxed max-w-2xl" style={{ color: '#8892A4' }}>
          ...
          >
            ...
            <div className="pt-6 border-t space-y-3 text-sm leading-relaxed" style={{ borderColor: 'rgba(75,127,255,0.12)', color: '#8892A4' }}>
              ...
              <p>
                Read our{' '}
                <a href="/privacy" className="underline" style={{ color: '#4B7FFF' }}>
                  Privacy Policy
                </a>{' '}
                and{' '}
                <a href="/terms" className="underline" style={{ color: '#4B7FFF' }}>
                  Terms of Service
                </a>.
              </p>
            </div>
