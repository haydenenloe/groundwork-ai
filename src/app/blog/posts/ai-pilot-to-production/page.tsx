        ...
        <div className="relative max-w-3xl mx-auto px-6 py-20">
          ...
          <header className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-sm" style={{ color: '#6F665A' }}>April 14, 2026</span>
