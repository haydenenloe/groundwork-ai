        ...
        <div className="relative max-w-3xl mx-auto px-6 py-20">
          ...
          <header className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-sm" style={{ color: '#6F665A' }}>May 26, 2026</span>
          ...
          <article className="prose-custom space-y-6" style={{ color: '#221D17', lineHeight: '1.8', fontSize: '1.0625rem' }}>
            ...
            <p>
              <strong style={{ color: '#221D17' }}>You have tribal knowledge that isn&apos;t documented.</strong> If the answer to &ldquo;how does this work?&rdquo; is &ldquo;ask Sarah,&rdquo; that process isn&apos;t automatable. Sarah is the system. AI can&apos;t replace a person who exists because no one wrote anything down.
            </p>

            <p>
              <strong style={{ color: '#221D17' }}>Your data lives in email threads or PDFs.</strong> If your process involves someone reading an email and typing information into a spreadsheet, you have a data flow problem, not an AI problem. The AI can eventually replace that human step — but first you need to admit the flow exists and map it out. Until you do, you&apos;re automating a mess.
            </p>

            <p>
              <strong style={{ color: '#221D17' }}>Your outputs are &ldquo;it depends.&rdquo;</strong> A good automation produces a predictable output given a predictable input. If your team&apos;s answer to &ldquo;what happens when X occurs?&rdquo; is frequently &ldquo;it depends on the situation,&rdquo; you&apos;re dealing with either undefined process or genuine judgment calls. Both need human attention before they need AI.
            </p>

            <p>
              <strong style={{ color: '#221D17' }}>Nobody agrees on what success looks like.</strong> AI projects stall when there&apos;s no clear definition of done. &ldquo;Automate our sales process&rdquo; is not a success criterion. &ldquo;Reduce time-to-quote from 48 hours to 4 hours&rdquo; is. If you can&apos;t put a number on it before you start, you won&apos;t be able to prove anything when it&apos;s running.
            </p>
